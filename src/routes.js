  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        exact: true,
        name: 'New User',
        component: lazy(() => import('./views/Accounts/Registration/Users'))
      },
      {
        path: '/registration/new-user',
        exact: true,
        name: 'New User',
        component: lazy(() => import('./views/Accounts/Registration/NewUser'))
      },
      {
        path: '/registration/new-user/:id',
        exact: true,
        name: 'New User',
        component: lazy(() => import('./views/Accounts/Registration/NewUser'))
      },
      {
        path: '/registration/new-organisation',
        exact: true,
        name: 'New Organisation',
        component: lazy(() => import('./views/Accounts/Organisation/NewOrganisation'))
      },
      {
        path: '/registration/new-organisation/:id',
        exact: true,
        name: 'New Organisation',
        component: lazy(() => import('./views/Accounts/Organisation/NewOrganisation'))
      },
      {
        path: '/registration/organisations',
        exact: true,
        name: 'Organisations',
        component: lazy(() => import('./views/Accounts/Organisation/Organisations'))
      },
      {
        path: '/registration/roles',
        exact: true,
        name: 'Roles',
        component: lazy(() => import('./views/Accounts/Roles/Roles'))
      },
      {
        path: '/registration/new-role',
        exact: true,
        name: 'New Role',
        component: lazy(() => import('./views/Accounts/Roles/New-Role'))
      },
      {
        path: '/registration/new-role/:id',
        exact: true,
        name: 'New Role',
        component: lazy(() => import('./views/Accounts/Roles/New-Role'))
      },
