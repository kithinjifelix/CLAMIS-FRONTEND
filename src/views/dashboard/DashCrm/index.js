                        ...
                        <Col md={6} xl={12}>
                            <Card>
                                <Card.Body>
                                    ...
                                    <h5 className="mt-3 text-c-blue mb-4"><i className="fa fa-caret-down text-c-blue f-22"/> 5.2% ($456)</h5>
                                    <Button variant='primary' className='shadow-2 text-uppercase btn-block' style={{maxWidth: '150px', margin: '0 auto'}}>add funds</Button>
                                </Card.Body>
                            </Card>
                        </Col>
                    </Row>
