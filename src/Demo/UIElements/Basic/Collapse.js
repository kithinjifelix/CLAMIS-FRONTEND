            ...
            <Aux>
                <Row>
                    <Col sm={12}>
                        ...
                        <Card>
                            <Card.Header>
                                <Button href={DEMO.BLANK_LINK} onClick={() => this.setState({isBasic: !isBasic})}
                                        aria-controls="basic-collapse" aria-expanded={isBasic}>Collapse Link</Button>
                    ...
                    <Col sm={12}>
                        ...
                        <hr/>
                        <Button onClick={() => this.targetHandler('target1')} aria-controls="target1"
                                aria-expanded={isMultiTarget.some(target => target === 'target1')}>Toggle first
                            element</Button>
                        <Button onClick={() => this.targetHandler('target2')} aria-controls="target2"
                                aria-expanded={isMultiTarget.some(target => target === 'target2')}>Toggle second
                            element</Button>
