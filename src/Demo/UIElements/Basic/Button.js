...
class BasicButton extends React.Component {
    render() {
        ...
        const squareButtons = buttonVariants.map((variant, idx) => <Button key={idx} className='btn-square'
                                                                           variant={variant}><UcFirst
            text={variant}/></Button>);
        ...
        return (
            <Aux>
                <Row>
                    <Col>
                        <Card title="Default">
                            <p>use <code>variant="*"</code> props in component <code>Button</code> to get various button
                            </p>
                            {basicButtons}
                        ...
                        <Card title="Outline">
                            <p>use <code>variant="outline-*"</code> props in component <code>Button</code> to get
                                various outline button</p>
                            {outlineButtons}
                        </Card>
                        <Card title="Square Button">
                            <p>use <code>className="btn-square"</code> props in component <code>Button</code> to get
                                square button</p>
                            {squareButtons}
                        </Card>
                    </Col>
