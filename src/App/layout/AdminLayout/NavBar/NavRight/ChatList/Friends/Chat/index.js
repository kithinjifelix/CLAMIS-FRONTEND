        ...
        <Aux>
            <div className={chatClass.join(' ')}>
                <div className="h-list-header">
                    ...
                    <a href={DEMO.BLANK_LINK} className="h-back-user-list" onClick={props.closed}><i
                        className="feather icon-chevron-left"/></a>
                </div>
                ...
                <div className="h-list-footer">
                    <div className="input-group">
                        ...
                        <input type="text" name="h-chat-text" className="form-control h-send-chat"
