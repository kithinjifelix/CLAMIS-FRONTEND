                                    ...
                                    <li className="notification">
                                        <div className="media">
                                            ...
                                            <div className="media-body">
                                                <p><strong>{this.state.user.name}</strong><span className="n-time text-muted"><i
                            ...
                            <Dropdown.Menu alignRight className="profile-notification">
                                ...
                                {/*<ul className="pro-body">
                                    <li><a href={DEMO.BLANK_LINK} className="dropdown-item"><i
                                        className="feather icon-settings"/> Settings</a></li>
                                    <li><a href={DEMO.BLANK_LINK} className="dropdown-item"><i
                                        className="feather icon-user"/> Profile</a></li>
                                    <li><a href={DEMO.BLANK_LINK} className="dropdown-item"><i
                                        className="feather icon-mail"/> My Messages</a></li>
                                    <li><a href={DEMO.BLANK_LINK} className="dropdown-item"><i
                                        className="feather icon-lock"/> Lock Screen</a></li>
                                </ul>*/}
                            </Dropdown.Menu>
                        </Dropdown>
                    </li>
